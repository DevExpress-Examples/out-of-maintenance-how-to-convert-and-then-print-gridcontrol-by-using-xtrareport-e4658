...
Namespace ReportHelper
    ...
    Public Class ReportGeneratonHelper
        ...
        Private Sub InitDetailsAndPageHeader(ByVal grid As DevExpress.Xpf.Grid.GridControl)
            ...
            Dim pagewidth As Integer = CInt((Me.report.PageWidth - (Me.report.Margins.Left + Me.report.Margins.Right))) - groupedColumns.Count * ReportHelper.ReportGeneratonHelper.subGroupOffset
